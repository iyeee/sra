    ...
    + 软件开发生命周期（SDLC）
      ...
      + 提出了许多过程模型 
        ...
        + Agile敏捷的 
          ...
          ![image-20211224165143732](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224165143732.png)
...
+ Form-based specifications 基于表单的规范
  ...
  ![image-20211224125349106](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224125349106.png)
...
+  UML：统一建模语言（UML）是一种用于指定、可视化、构造和记录软件系统工件的语言。
  ...
  + RE related diagrams
    ...
    ![image-20211224130053180](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130053180.png)

    ![image-20211224130114573](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130114573.png)

    ![image-20211224130131015](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130131015.png)

    ![image-20211224130146696](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130146696.png)

    ![image-20211224130158633](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130158633.png)

    ![image-20211224130211010](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130211010.png)
...
+ 4.1形式规范基础
  ...
  + 形式规范基础
    ...
    ![image-20211224130856755](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224130856755.png)
...
+ 正式的方法
  ...
  + 形式化规范工具概述
    ...
    ![image-20211224132538973](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224132538973.png)
  ...
  + 形式化规格说明语言的分类
    ...
    ![image-20211224132700067](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224132700067.png)
...
+ 4.2  Z规范
  ...
  +  Z形式说明由一组”模式”构成
    ...
    + 操作模式
      ...
      ![image-20211224132843950](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224132843950.png)
    ...
    + Z说明例1---停车场管理系统
      ...
      + 状态模式定义：
        ...
        ![image-20211224135104219](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135104219.png)
    ...
    + Z说明例1---停车场管理系统
      ...
      + 操作模式定义
        ...
        ![image-20211224135220339](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135220339.png)
  ...
  + Z说明例2---电梯控制系统
    ...
    + 状态模式定义：
      ...
      ![image-20211224135334692](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135334692.png)

+ Z说明例2---电梯控制系统

  + 状态变量初始化：
               ![image-20211224135421105](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135421105.png)

  + 操作模式定义

    ![image-20211224135438083](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135438083.png)
  ...
  + 什么是Tabular Expression? 列表表达式?
    ...
    + 不同的名称:
      ...
      + 例子
        ...
        ![image-20211224135932743](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224135932743.png)

      + 规范和描述

        ![image-20211224140300465](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224140300465.png)
        ...
        + 10表列表达式类型
          ...
          + 一些概念
            ...
            +  Scalar Expression(标量表达式):
              ...
              + ![image-20211224141141347](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141141347.png)
            + 网格（grid）：索引化集合G
              + 索引集合：{1,…,m1} ×……× {1,…,mn}
              + 维数：dim(G)=n
              + 长度：leni (G) = mi
          ...
          + Examples of TenTable Types
            ...
            + Normal Function Table
              ...
              ![image-20211224141404102](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141404102.png)

            + Inverted Function Tables

              ![image-20211224141425056](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141425056.png)

            + Vector Function Table

              ![image-20211224141519238](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141519238.png)

            + Normal Relation Table

              ![image-20211224141542102](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141542102.png)

            + Inverted Relation Table

              ![image-20211224141613861](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141613861.png)

            + Vector Relation Table

              ![image-20211224141631529](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141631529.png)

            + Mixed Vector Table

              ![image-20211224141651373](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141651373.png)

            + Predicate Expression Table

              ![image-20211224141711714](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141711714.png)

            + Characteristic Predicate Table

              ![image-20211224141734509](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141734509.png)

            + Generalized Decision Table

              ![image-20211224141749659](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141749659.png)

              ![image-20211224141808043](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141808043.png)

              ![image-20211224141823547](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141823547.png)

              ![image-20211224141837119](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141837119.png)

              ![image-20211224141848027](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224141848027.png)
  ...
  +  IEEE Std 830-1998
    ...
    + 附样本说明
      ...
      + CS445 (Winter 2011)
        ...
        ![image-20211224143233011](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143233011.png)

        ![image-20211224143246915](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143246915.png)

        ![image-20211224143255397](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143255397.png)

        ![image-20211224143307858](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143307858.png)

        ![image-20211224143319743](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143319743.png)

        ![image-20211224143328721](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143328721.png)

        ![image-20211224143335129](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143335129.png)

        ![image-20211224143341558](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143341558.png)

        ![image-20211224143348519](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143348519.png)

        ![image-20211224143358721](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143358721.png)

        ![image-20211224143405276](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143405276.png)

        ![image-20211224143411114](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143411114.png)

        ![image-20211224143417601](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143417601.png)

        ![image-20211224143424772](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143424772.png)

        ![image-20211224143430776](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143430776.png)

        ![image-20211224143436798](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143436798.png)

        ![image-20211224143443049](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143443049.png)

        ![image-20211224143450265](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143450265.png)

        ![image-20211224143458751](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143458751.png)

        ![image-20211224143504955](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143504955.png)

        ![image-20211224143516788](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143516788.png)

        ![image-20211224143530398](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143530398.png)
...
+  National Standard
  ...
  + 国家标准
    ...
    +  GBT 9385-2008计算机软件需求规格说明书规范
      ...
      ![image-20211224143543634](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143543634.png)

      ![image-20211224143549481](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143549481.png)

      ![image-20211224143556061](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143556061.png)

      ![image-20211224143602783](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143602783.png)

      ![image-20211224143613973](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224143613973.png)
...
+ 2.3Functional Test Design 功能测试设计（开发测试用例）
  ...
  + 软件测试:
    ...
    + 关注锻炼和观察产品行为或质量属性
      ...
      ![image-20211224150619946](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224150619946.png)
...
+ 2.5Requirements Traceability 需求可追溯性（利用跟踪关系）
  ...
  + 验证不必要需求:自下而上
    ...
    ![image-20211224151257354](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224151257354.png)
...
+ 2.6Automation Tools自动化工具
  ...
  + 完整性已证明
    ...
    ![image-20211224151441648](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224151441648.png)
...
+  管理需求工程活动
   ...
   ![image-20211224152656714](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224152656714.png)
...
+ 2.2可追溯性的分类
  ...
  + 方向：向前与向后跟踪
    ...
    ![image-20211224153143346](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153143346.png)
  ...
  + 扩展的前后可追溯性
    ...
    ![image-20211224153306158](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153306158.png)

+ 2.3可追溯性信息的呈现 

  + 文本参考

  ![image-20211224153448409](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153448409.png)

  + 超链接

  ![image-20211224153458904](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153458904.png)

+ 跟踪矩阵

  ![image-20211224153631225](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153631225.png)

  ![image-20211224153646206](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153646206.png)

  ![image-20211224153659413](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224153659413.png)
...
+ 3.3需求优先级划分技术
  ...
  + 3.3.2 Kano分类
    ...
    + 根据系统特性(或顾客要求)对顾客满意的影响进行分类
      ...
      ![image-20211224154657410](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224154657410.png)

      ![image-20211224154832739](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224154832739.png)

  + 3.3.3Two-Criteria Classification双准则分类

    ![image-20211224154903889](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224154903889.png)
  ...
  + 3.3.4 Wiegers的优先级矩阵
    ...
    + 需求优先级的执行是基于这样一个假设:需求的优先级与它的收益(如果实现了)和惩罚(如果没有实现)成正比，与需求的成本和风险成反比
      ...
      ![image-20211224155049418](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224155049418.png)
  ...
  + 3.3.5Cost-Value Approach 成本-价值法
    ...
    + 计算投资回报(ROI)
      ...
      ![image-20211224155235269](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224155235269.png)
    ...
    + 层次优先级
      ...
      + 只对单个节点的分支进行比较:
        ...
        ![image-20211224160406511](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224160406511.png)

        ![image-20211224160417263](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224160417263.png)

        ![image-20211224160435805](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224160435805.png)

        ![image-20211224160447364](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224160447364.png)
    ...
    + 绘制ROI图
      ...
      + 使用结果计算ROI率
        ...
        ![image-20211224160557480](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224160557480.png)
  ...
  + 4.3变更管理流程
    ...
    ![image-20211224161704563](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224161704563.png)

    ![image-20211224161802571](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224161802571.png)
    ...
    + 成员:
      ...
      ![image-20211224161933663](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224161933663.png)
    ...
    + 影响分析
      ...
      + 对后续工件的影响分析
        ...
        ![image-20211224162025413](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224162025413.png)
...
+ 5.2如何选择工具?
  ...
  + 商业需求管理工具示例
    ...
    ![image-20211224163136600](https://cdn.jsdelivr.net/gh/iyeee/imgs/picgo/image-20211224163136600.png)
